...
<div class="container py-4">
  <div class="row">
    ...
    <main class="col-lg-12 col-md-10 main-content">

      <h2 class="d-block  d-md-none text-uppercase text-center">Contact Us</h2>

      <form id="contact_form" action="send.php" method="post" class="p-5 mt-5 contact-form" class="needs-validation novalidate">
